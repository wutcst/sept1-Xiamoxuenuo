 ...
 *
 * @author  Michael Kölling and David J. Barnes and Xiamoxuenuo
 * @version 1.0.0
 */
...
public class Game
{
    ...
    private void createRooms()
    {
        ...
        outside.addItem("apple","taste good", 100);

        theater.setExit("west", outside.getId());
        theater.addItem("sword","atk++", 750);
        theater.addItem("shield","def++", 500);

        pub.setExit("east", outside.getId());

        lab.setExit("north", outside.getId());
        lab.setExit("east", office.getId());
        lab.addItem("magic cookie","strength++", 20);
